...
RSpec.describe 'the users show page' do
  ...
  before :each do
    @user_1 = User.create!(name: 'Alfonso Diogenes', email: 'alphonsodiogenes420@hotmail.com', password:'MyLifeIsAgony')
    @user_2 = User.create!(name: 'Cradley Booper', email: 'cradleybooper420@hotmail.com', password: 'ICanFeelThemChewing')
    @user_3 = User.create!(name: 'Jangelina Aolie', email: 'jangelinaaolie420@hotmail.com', password: 'WhenWillThisEnd')
